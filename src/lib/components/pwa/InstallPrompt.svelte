...
{#if visible}
  <section class="fixed inset-x-4 bottom-4 z-40 mx-auto max-w-xl rounded-lg border border-primary-500/30 bg-slate-800 p-4 shadow-dark-xl">
    <div class="flex gap-3">
      ...
      <div class="min-w-0 flex-1">
        <h2 class="text-sm font-semibold text-slate-100">Add HuntFlow to Home Screen</h2>
        ...
        <div class="mt-3 flex flex-wrap gap-2">
          ...
          {:else}
            <p class="rounded-md border border-slate-700 bg-slate-900 px-3 py-2 text-xs text-slate-400">
      ...
      <button
        type="button"
        class="inline-flex h-10 min-h-[40px] w-10 shrink-0 items-center justify-center rounded-lg text-slate-400 transition hover:bg-slate-700 hover:text-slate-100"
