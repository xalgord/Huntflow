<script lang="ts">
   ...
   * `#0e1612` card, `#60ff5c` accent for the price and the feature
...
<style>
  ...
  .plan-card {
    ...
    padding: 1.75rem;
    border-radius: 1rem;
    border: 1px solid rgba(96, 255, 92, 0.28);
    ...
    box-shadow:
      ...
      0 0 32px rgba(96, 255, 92, 0.08);
    transition: border-color 200ms ease, box-shadow 200ms ease;
  }

  .plan-card:hover {
    border-color: rgba(96, 255, 92, 0.45);
    box-shadow:
      inset 0 1px 0 rgba(255, 255, 255, 0.04),
      0 1px 2px rgba(0, 0, 0, 0.3),
      0 0 48px rgba(96, 255, 92, 0.18);
  }
  ...
  .plan-card__badge {
    ...
    color: #070d0a; /* zinc-950 */
    font-size: 0.6875rem;
    font-weight: 600;
    letter-spacing: 0.18em;
    text-transform: uppercase;
    line-height: 1.2;
    box-shadow: 0 0 12px rgba(96, 255, 92, 0.35);
  }
  ...
  .plan-card__eyebrow {
    ...
    text-transform: uppercase;
    color: rgba(134, 239, 172, 0.85); /* green-300, 85% — clears AA on `#0e1612` */
  }
  ...
  .plan-card__price {
    ...
    line-height: 1;
    color: #60ff5c;
    text-shadow: 0 0 16px rgba(96, 255, 92, 0.25);
  }
  ...
  .plan-card__check {
    ...
    color: #86efac; /* green-300 — clears AA on the tinted surface */
    border: 1px solid rgba(96, 255, 92, 0.3);
  }
